...
public class DataSetMeasurements extends AbstractChartMeasurement {
    ...
    public DataSetMeasurements(final ParameterMeasurements plugin, final MeasurementType measType) { // NOPMD
        ...
        measurementSelector = new ChartMeasurementSelector(plugin, isTrending ? measType.getRequiredDataSets() : 0);
        if (isTrending) {
    ...
    public void initialize() {
        ...
        dataSetSelector.getDataSetListView().getSelectionModel().setSelectionMode(SelectionMode.MULTIPLE);
    ...
    public enum MeasurementType {
        ...
        ADD_VALUE(true, MATH, "DataSet1 + value", 0, 1),
