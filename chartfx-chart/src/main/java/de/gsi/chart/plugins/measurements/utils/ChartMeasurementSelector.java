...
public class ChartMeasurementSelector extends GridPane {
    ...
    public ChartMeasurementSelector(final ParameterMeasurements plugin, final int requiredNumberOfChartMeasurements) {
        super();
        if (plugin == null) {
        ...
        chartMeasurementListView = new ListView<>(plugin.getChartMeasurements());
