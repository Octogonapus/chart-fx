...
public class ChartMeasurementSelectorTests {
    ...
    public void start(Stage stage) {
        ...
        assertThrows(IllegalArgumentException.class, () -> new ChartMeasurementSelector(null, 0));
        for (int nDataSets = 0; nDataSets < 3; nDataSets++) {
            final int nDataSetsLocal = nDataSets;
            assertDoesNotThrow(() -> new ChartMeasurementSelector(plugin, nDataSetsLocal));
        }
        ...
        field = new ChartMeasurementSelector(plugin, 1);
